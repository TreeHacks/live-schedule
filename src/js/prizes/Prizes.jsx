...
import Vespa from "../../logos/vespa.webp";
...
export default class extends React.Component {
  constructor(props) {
    ...
    const sponsorPrizeData = [
      ...
      {
        name: "Best Use of GenAI using InterSystems IRIS Vector Search (1st)",
        description:
          "InterSystems IRIS Vector Search is our new vector store feature within the IRIS Data Platform! But we're not a "vector database" just like we're not a "string database" or "integer database" 😉 -- embedding vectors are just another SQL datatype for us!  Build your groundbreaking solution on InterSystems IRIS data platform, which gives you the tools to seamlessly integrate GenAI, tabular AutoML, data interoperability, using simple SQL or Python LangChain/Llamaindex connectors! The most innovative solution that leverages GenAI using InterSystems IRIS will win cash prizes!",
        contents: {
          1: {
            name: "$2,000 Cash",
          },
